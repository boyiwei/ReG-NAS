...
from torch_geometric.graphgym.proxy import proxy
...
"""
This pipeline is proxy task using Random Generated Vector as proxy task
"""
...
if __name__ == '__main__':
    ...
    for i in range(args.repeat):
        ...
        if cfg.train.mode == 'standard':
            proxy(loggers, loaders, model, optimizer, scheduler)
        else:
