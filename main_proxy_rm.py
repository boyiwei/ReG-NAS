...
from torch_geometric.graphgym.golden_model_train import attach_golden_vec, attach_random_vec

"""
This pipeline is proxy task using Random Model Generated proxy task
"""
if __name__ == '__main__':
    ...
    for i in range(args.repeat):
        ...
        attach_golden_vec(loaders)
        # attach_random_vec(loaders)
